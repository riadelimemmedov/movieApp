...
SECRET_KEY = 'django-insecure-lm=64pvv@&_+5^jbv4hy(8_$_^w(25iyogzpcznt)$p)s+3%_@'
...
MEDIA_URL = '/file/'#butun sekilleri saxlayan fayldir bura hemise kok dizin kimi olur ele bil
...
#Activate Etmek Ucun Sanal Ortami yeni virtual enviroment => myenv\Scripts\activate  
